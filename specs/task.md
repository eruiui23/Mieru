...
- [x] **Task 5.1: Backend Text Dissection Pipeline:** Integrate a text parser (like pykakasi) and a dictionary engine (like jamdict) into the backend services layer to dissect raw text strings into structured dictionaries containing tokens, furigana, rōmaji, and English definitions.
